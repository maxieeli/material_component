...
/**
 * This function will do as `Object.assign` in production.
 * But will use Object.defineProperty:get to pass all value access in development.
 * To support statistic field usage with alias token.
 * Object.defineProperty 后使用 object.assign 会报错，因 object.assign 会调用 getter
 */
...
/** @private Internal Usage. Not use. */
