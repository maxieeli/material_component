import Pagination from '@developerli/basic-pagination/es/locale/zh_HK';
import DatePicker from '../DatePicker/locale/date_ZH_HK';
import type { Locale } from './types';
import TimePicker from '../DatePicker/locale/time_ZH_HK';
