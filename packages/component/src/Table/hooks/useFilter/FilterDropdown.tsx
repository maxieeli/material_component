...
import type { FieldDataNode } from '@developerli/basic-tree'
...
function hasSubMenu(filters: Array<ColumnFilterItem>) {
...
function FilterDropdown<RecordType>(props: FilterDropdownProps<RecordType>) {
  ...
  const mergedVisible = filterDropdownOpen ?? visible

  // ===================== Select Keys =====================
  const propFilteredKeys = filterState?.filteredKeys
  const [getFilteredKeysSync, setFilteredKeysSync] = useSyncState(propFilteredKeys || [])

  const onSelectKeys = ({ selectedKeys }: { selectedKeys: Array<Key> }) => {
  ...
  const onCheck = (
    ...
    if (!filterMultiple) {
      ...
      onSelectKeys({ selectedKeys: keys as Array<Key> })
    }
  }
  ...
  // ======================= Submit ========================
  // @ts-ignore
  const internalTriggerFilter = (keys: Array<Key> | undefined | null) => {
  ...
  if (typeof column.filterDropdown === 'function') {
    dropdownContent = column.filterDropdown({
      ...
      setSelectedKeys: (selectedKeys: Array<Key>) => onSelectKeys({ selectedKeys }),
