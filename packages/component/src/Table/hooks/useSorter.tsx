...
function nextSortDirection(sortDirections: Array<SortOrder>, current: SortOrder | null) {
  if (!current) {
...
function injectSorter<RecordType>(
  ...
  defaultSortDirections: Array<SortOrder>,
  ...
  return (columns || []).map((column, index) => {
    ...
    if (newColumn.sorter) {
      const sortDirections: Array<SortOrder> = newColumn.sortDirections || defaultSortDirections
