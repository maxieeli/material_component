...
import { FormatListBulleted, ChevronRight, ChevronLeft } from '@mui/icons-material'
...
const Sider = React.forwardRef<HTMLDivElement, SiderProps>(
  (
    ...
    useEffect(() => {
      const uniqueId = generateId('mui-sider-')
    ...
    const renderSider = () => {
      ...
      const zeroWidthTrigger =
        parseFloat(String(collapsedWidth || 0)) === 0 ? (
          ...
          >
            {trigger || <FormatListBulleted />}
          </span>
        ) : null
      const iconObj = {
        expanded: reverseArrow ? <ChevronRight /> : <ChevronLeft />,
        collapsed: reverseArrow ? <ChevronLeft /> : <ChevronRight />,
      }
